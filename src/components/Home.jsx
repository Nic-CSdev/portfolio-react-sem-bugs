  ...
  return (
    <div name='home' id="home" className='w-full h-screen bg-[#030507] home-content'>
      <div className='max-w-[1000px] mx-auto px-8 flex flex-col justify-center h-full'>
        ...
        <p className='text-[#8892b0] py-4 max-w-[700px]'>Bem-vindo ao meu portfólio!!! Aqui você pode encontrar meus projetos, currículo, um pouco sobre mim e entrar em contato comigo.</p>
